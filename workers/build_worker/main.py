...
WORKER_NAME = "build_worker"
SUBJECT = "task.build.requested"
DURABLE = "inova-build-worker"
COMPLETED_SUBJECT = "task.build.completed"
DESCRIPTION = "Executa build e valida artefatos."
