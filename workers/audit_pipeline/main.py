...
WORKER_NAME = "audit_pipeline"
SUBJECT = "task.audit.requested"
DURABLE = "inova-audit-pipeline"
COMPLETED_SUBJECT = "task.audit.completed"
DESCRIPTION = "Audita pipeline, contratos e qualidade minima."
