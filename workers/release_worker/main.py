...
WORKER_NAME = "release_worker"
SUBJECT = "task.release.requested"
DURABLE = "inova-release-worker"
COMPLETED_SUBJECT = "task.release.completed"
DESCRIPTION = "Executa validacao de release."
